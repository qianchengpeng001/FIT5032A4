...
namespace _21S2_BZ_2.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,f_name,l_name,address,phone")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,f_name,l_name,address,phone")] Patient patient)
        {
            if (ModelState.IsValid)
            {
